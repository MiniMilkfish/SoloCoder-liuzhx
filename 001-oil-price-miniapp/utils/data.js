...
const oilTypes = [
  { name: '92#汽油', code: '92', unit: '元/升' },
  { name: '95#汽油', code: '95', unit: '元/升' },
  { name: '98#汽油', code: '98', unit: '元/升' },
  { name: '0#柴油', code: '0', unit: '元/升' },
  { name: '-10#柴油', code: '-10', unit: '元/升' }
]
...
function getOilTypeByCode(code) {
  return oilTypes.find(type => type.code === code)
}

function getMockOilPrice(city, oilTypeCode) {
  const cityPrices = mockOilPrices[oilTypeCode] || {}
  const basePrice = cityPrices[city] || 7.85
